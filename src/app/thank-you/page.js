    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 flex items-center justify-center px-4 py-8 md:py-12">
      ...
      >
        ...
        >
          {/* Header with Logo */}
          <motion.div
            className="bg-[#ffe4cc] py-8 px-6 text-center"
            variants={itemVariants}
          >
            <motion.div
          ...
          <div className="px-6 md:px-12 pb-10">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Your form has been submitted successfully. Our admissions team will get in touch with you shortly to
              discuss your application and answer any questions you may have.
            </motion.p>
