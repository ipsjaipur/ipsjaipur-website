...
export default function BoardOfAdvisorsBannerEditor() {
  return (
    <BoardOfAdvisorsSectionEditorShell
      sectionKey="banner"
      title="Banner"
      description="Hero banner title, background image, and image alignment."
    >
      {(data, setData) => {
        ...
        return (
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5 space-y-4">
            ...
            <Field
              label="Page Title (shown as hero heading and breadcrumb)"
              value={data?.bannerTitle}
              onChange={set('bannerTitle')}
              placeholder="Board of Advisors"
            />
