    ...
    <div className="space-y-3">
      <div>
        ...
        <input type="text" value={item.name || ''} onChange={(e) => update({ name: e.target.value })}
          placeholder="e.g. BCA RTU Syllabus"
...
export default function BCASyllabusEditor() {
  return (
    <BCASectionEditorShell sectionKey="syllabus" title="Syllabus"
      description="Manage syllabus PDF download links shown on the BCA page.">
      {(data, setData) => (
