...
export default function BCASidebarEditor() {
  return (
    <BCASectionEditorShell sectionKey="sidebar" title="Sidebar Videos"
      description="YouTube embed videos shown in the right sidebar of the BCA page.">
      {(data, setData) => (
        <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5">
          ...
          <SortableList items={data?.sidebarVideos || []}
