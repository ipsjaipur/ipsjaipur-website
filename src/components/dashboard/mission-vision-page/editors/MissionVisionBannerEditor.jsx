...
export default function MissionVisionBannerEditor() {
  return (
    <MissionVisionSectionEditorShell
      sectionKey="banner"
      title="Banner"
      description="Hero banner image, page title, and image focal position for the Mission & Vision page."
    >
      {(data, setData) => {
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5 space-y-4">
              ...
              <p className="text-[12px] text-[#77838f]">
                ...
                <code className="bg-gray-100 px-1 rounded text-[11px]">f_auto,q_auto,w_1920</code> automatically.
              </p>
              <ImageUpload
