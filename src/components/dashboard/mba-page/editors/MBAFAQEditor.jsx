...
// FAQItemWrapper removed — FAQItem is now a proper component, used directly

export default function MBAFAQEditor() {
  return (
    <MBASectionEditorShell
      sectionKey="faq"
      title="FAQ"
      description="Manage frequently asked questions shown at the bottom of the MBA page."
    >
      {(data, setData) => (
        <>
