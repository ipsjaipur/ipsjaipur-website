  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <label htmlFor={`doc-bold-${index}`} className="text-[13px] font-medium text-[#4a5568]">
          Show as bold text
        </label>
      </div>
    </div>
...
export default function MBADocumentsEditor() {
  return (
    <MBASectionEditorShell
      sectionKey="documentsRequired"
      title="Documents Required"
      description="List of documents students need to submit for MBA admission."
    >
      {(data, setData) => (
        <>
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5">
            ...
            <p className="text-[12px] text-[#77838f] mb-4">
              Each item appears with a lightbulb icon. Check &quot;bold&quot; for important items like Aadhar/Application form.
            </p>
            <SortableList
