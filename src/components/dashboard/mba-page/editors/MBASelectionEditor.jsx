...
export default function MBASelectionEditor() {
  return (
    <MBASectionEditorShell
      sectionKey="selectionProcedure"
      title="Selection Procedure"
      description="Step-by-step selection process shown on the MBA page."
    >
      {(data, setData) => (
        <>
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5">
            ...
            <p className="text-[12px] text-[#77838f] mb-4">
              Each step renders its label in bold, followed by the description on the next line.
            </p>
            <SortableList
              items={data?.selectionSteps || []}
