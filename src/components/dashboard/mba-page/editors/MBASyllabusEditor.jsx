    ...
    <div className="space-y-3">
      <div>
        ...
        <input
          ...
          placeholder="e.g. MBA Syllabus (1st Semester)"
...
export default function MBASyllabusEditor() {
  return (
    <MBASectionEditorShell
      sectionKey="syllabus"
      title="Syllabus"
      description="Manage syllabus PDF download links shown on the MBA page."
    >
      {(data, setData) => (
        <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5">
          <div className="mb-4">
            ...
            <input
              type="text"
              value={data?.syllabusHeading || ''}
              onChange={(e) => setData({ ...data, syllabusHeading: e.target.value })}
          ...
          <p className="text-[12px] text-[#77838f] mb-4">
            Upload a PDF directly to Cloudinary, or paste an existing URL. Each item renders as a clickable download
            link on the page.
          </p>
          <SortableList
