...
export default function MBAAdmissionEditor() {
  return (
    <MBASectionEditorShell
      sectionKey="admissionProcess"
        ...
        <>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5">
            ...
            <p className="text-[12px] text-[#77838f] mb-4">
              Each step shows as <strong>Label :</strong> Description. Add an optional link below each step.
            </p>
            <SortableList
              items={data?.admissionSteps || []}
