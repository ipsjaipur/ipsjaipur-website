...
export default function CareerBannerEditor() {
  return (
    <CareerSectionEditorShell
      sectionKey="banner"
      title="Banner"
      description="Hero banner image, page title, and image focal position for the Career page."
    >
      {(data, setData) => {
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5 space-y-4">
              ...
              <Field
                ...
                placeholder="Career @ IPS BUSINESS SCHOOL"
              />
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5 space-y-4">
              ...
              <p className="text-[12px] text-[#77838f]">
                Recommended: wide landscape image (1920×600). Cloudinary images are served with{' '}
                <code className="bg-gray-100 px-1 rounded text-[11px]">f_auto,q_auto,w_1920</code>{' '}
                automatically. Leave blank to use the default static image.
              </p>
              <ImageUpload
            ...
            <div className="bg-white rounded-2xl border border-[#e2e8f0] p-5 space-y-4">
              ...
              <div>
                ...
                <select
                  value={data?.bannerPosition || 'object-center'}
                ...
                >
                  ...
                  <option value="object-[50%_35%]">Center-upper (50% 35%)</option>
                </select>
              </div>
            </div>
          </>
