...
const FALLBACK_CARDS = [
  ...
  { icon: 'images/home/advertisig-agency.webp', title: 'Additional Digital Marketing Course', color: '#FF6B00' },
  { icon: 'images/home/monitor.webp', title: 'Additional Data/Business Analytics Course', color: '#FF6B00' },
  { icon: 'images/home/exellent.webp', title: '18+ Years Of Excellence In Technical Education', color: '#FF9E3D' },
  {
    icon: 'images/home/artificial-intelligence.webp',
    title: 'Additional Artificial Intelligence and Machine Learning Course',
    color: '#FF9E3D',
  },
  { icon: 'images/home/foreign.webp', title: '3 Months Foreign Immersion Programme Each Year', color: '#FF9E3D' },
  { icon: 'images/home/experienced.webp', title: 'Best & Experienced Faculty Members', color: '#FF9E3D' },
  {
    icon: 'images/home/ranking.webp',
    title: 'Top Ranked College For Best Placements In The Country',
    color: '#FF6B00',
  },
  { icon: 'images/home/save.webp', title: 'Leading College With Affordable Fee Structure', color: '#FF6B00' },
  { icon: 'images/home/group.webp', title: 'Strong Alumni Network', color: '#FF6B00' },
];
const FALLBACK_CENTER_IMAGE = 'images/home/ab-n-1.webp';
...
export default function PathwayToExcellence({ data }) {
  ...
  const allCards =
    data?.pathwayCards?.length > 0
      ...
      : FALLBACK_CARDS.map((c, i) => ({ ...c, icon: `${process.env.NEXT_PUBLIC_IMG_PATH}${c.icon}` }));
  ...
  const imageVariants = {
    ...
    show: { opacity: 1, scale: 1, y: 0, transition: { delay: 0.4, duration: 0.4 } },
  };
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1202px] mx-auto">
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          {/* ── Graduate Image for Mobile/Tablet ─────────────────────────────── */}
          <motion.div
          ...
          >
            <div className="w-[150px] md:w-[200px] mx-auto">
              <img src={centerImage} alt="Graduate Student" className="w-full h-full object-contain drop-shadow-2xl" />
            </div>
          </motion.div>
        </div>
      </div>
